...
function WrapperButton({
  ...
  return (
    ...
    >
      {showCloseButton ? (
        <div
          className="absolute z-10 shadow-chw bg-white top-0 right-0 cursor-pointer rounded-full justify-center items-center flex p-1 transition delay-50 duration-200 ease-in-out hover:-translate-y-1 hover:scale-110 hover:bg-gray-100 "
